...
public class Symptoms extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MobileAds.initialize(getContext(), "ca-app-pub-3624608645361712~5778519950");//this is app id
        AdView adView = new AdView(getContext());
         AdView mAdView = view.findViewById(R.id.adView);
        AdRequest adRequest = new AdRequest.Builder().build();//this is test device id
        mAdView.loadAd(adRequest);
        adView.setAdSize(AdSize.BANNER);
        adView.setAdUnitId("ca-app-pub-3624608645361712/3152356615");//this is ad id
